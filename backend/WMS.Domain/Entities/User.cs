...
public partial class User
{
    ...
    public virtual ICollection<WmsTask> TaskAssignees { get; set; } = new List<WmsTask>();

    public virtual ICollection<WmsTask> TaskCreatedByNavigations { get; set; } = new List<WmsTask>();
