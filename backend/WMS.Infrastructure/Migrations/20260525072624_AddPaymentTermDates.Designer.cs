...
namespace WMS.Infrastructure.Migrations
{
    ...
    [Migration("20260525072624_AddPaymentTermDates")]
    partial class AddPaymentTermDates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WMS.Domain.Entities.AiAnalysisSession", b =>
                {
                    ...
                    b.Property<string>("SessionType")
                        ...
                        .HasDefaultValue("IMAGE_ANALYSIS")
                    ...
                    b.ToTable("ai_analysis_sessions", (string)null);
                });
            ...
            modelBuilder.Entity("WMS.Domain.Entities.Equipment", b =>
                {
                    ...
                    b.HasIndex(new[] { "IotDeviceId" }, "UQ__equipments__iot")
                        .IsUnique()
                        .HasFilter("[iot_device_id] IS NOT NULL");

                    b.HasIndex(new[] { "SerialNumber" }, "UQ__equipments__serial")
                        .IsUnique()
            ...
            modelBuilder.Entity("WMS.Domain.Entities.ReceiptNote", b =>
                {
                    ...
                    b.Property<decimal?>("CapacityOverflow")
                        .HasColumnType("decimal(10, 3)")
                        .HasColumnName("capacity_overflow");
            ...
            modelBuilder.Entity("WMS.Domain.Entities.RentalContract", b =>
                {
                    ...
                    b.Property<decimal?>("EarlyTerminationFee")
                        .HasColumnType("decimal(18, 2)")
                        .HasColumnName("EarlyTerminationFee");
            ...
            modelBuilder.Entity("WMS.Domain.Entities.RentalPayment", b =>
                {
                    ...
                    b.Property<string>("ProofRequestReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("proof_request_reason");

                    b.Property<DateTime?>("ProofRequestedAt")
                        .HasColumnType("datetime2")
                        .HasColumnName("proof_requested_at");
            ...
            modelBuilder.Entity("WMS.Domain.Entities.RentalRequest", b =>
                {
                    ...
                    b.Property<string>("AdditionalZonesJson")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("additional_zones_json");
                    ...
                    b.Property<double?>("ExtensionLength")
                        .HasColumnType("float")
                        .HasColumnName("extension_length");

                    b.Property<double?>("ExtensionPositionX")
                        .HasColumnType("float")
                        .HasColumnName("extension_position_x");

                    b.Property<double?>("ExtensionPositionY")
                        .HasColumnType("float")
                        .HasColumnName("extension_position_y");

                    b.Property<double?>("ExtensionWidth")
                        .HasColumnType("float")
                        .HasColumnName("extension_width");

                    b.Property<bool>("HasExtensionZone")
                        .HasColumnType("bit")
                        .HasColumnName("has_extension_zone");
                    ...
                    b.Property<bool>("IsOwnerAssigned")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasColumnName("is_owner_assigned");
            ...
            modelBuilder.Entity("WMS.Domain.Entities.SubscriptionPackage", b =>
                {
                    ...
                    b.Property<bool>("AllowEquipmentManagement")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasColumnName("allow_equipment_management");
                    ...
                    b.Property<int>("MaxStaffPerWarehouse")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(5)
                        .HasColumnName("max_staff_per_warehouse");

                    b.Property<decimal>("MaxTotalArea")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18, 2)")
                        .HasDefaultValue(500m)
                        .HasColumnName("max_total_area");
                    ...
                    b.Property<int>("MaxZonesPerWarehouse")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(3)
                        .HasColumnName("max_zones_per_warehouse");
            ...
            modelBuilder.Entity("WMS.Domain.Entities.WarehouseMembership", b =>
                {
                    ...
                    b.HasIndex("UserId", "WarehouseId", "WarehouseRoleId")
                        .IsUnique()
