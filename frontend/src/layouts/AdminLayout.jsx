...
import { LayoutDashboard, Users, Warehouse, ClipboardList, BarChart3, Settings, LogOut } from "lucide-react";
      ...
      <div className="admin-layout">
        ...
        <aside className="admin-sidebar">
          ...
          <div className="admin-sidebar-user">
            ...
            <button onClick={handleLogout} style={{ background: "none", border: "none", color: "#8892a4", cursor: "pointer", padding: 4 }} title="Đăng xuất">
              <LogOut size={16} />
            </button>
          </div>
        </aside>
