...
const MENU_BY_ROLE = {
  OWNER: [
    ...
    { icon: 'pending_actions',label: 'Yêu cầu thuê (chủ kho)',path: '/pending-rental-requests' },
    { icon: 'receipt_long',   label: 'Yêu cầu thuê của tôi', path: '/my-rental-requests' },
  ...
  RENTER: [
    ...
    { icon: 'pending_actions', label: 'Yêu cầu thuê kho',   path: '/my-rental-requests',       section: 'THUÊ KHO' },
    { icon: 'description',     label: 'Hợp đồng thuê',      path: '/my-contracts' },
