...
const MENU_BY_ROLE = {
  ...
  ADMIN: [{ icon: "admin_panel_settings", label: "Quản trị", path: "/admin" }],
};
          ...
          >
            <img
              src={
                user.avatarUrl ||
                user.AvatarUrl ||
                `https://ui-avatars.com/api/?name=${encodeURIComponent(user.fullName || user.FullName || "User")}&background=00b2d6&color=fff`
              }
              alt="Avatar"
