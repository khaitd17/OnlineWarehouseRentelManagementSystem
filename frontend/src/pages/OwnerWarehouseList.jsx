            ...
            <div style={{ padding: "24px", flex: 1, display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ display: "flex", gap: "12px", marginTop: "4px" }}>
                <div style={{ flex: 1, backgroundColor: "#f8fafc", padding: "12px", borderRadius: "12px", border: "1px solid #e2e8f0" }}>
                  ...
                  <div style={{ fontSize: "1.2rem", fontWeight: 800, color: "#1e293b" }}>{w.totalArea > 0 ? w.totalArea : "—"} <span style={{ fontSize: "0.9rem", color: "#94a3b8" }}>{w.totalArea > 0 ? "m²" : ""}</span></div>
                </div>
                <div style={{ flex: 1, backgroundColor: "#f0fdf4", padding: "12px", borderRadius: "12px", border: "1px solid #dcfce7" }}>
                  ...
                  <div style={{ fontSize: "1.2rem", fontWeight: 800, color: "#15803d" }}>{(w.availableArea ?? -1) > 0 ? w.availableArea : (w.totalArea > 0 ? w.totalArea : "—")} <span style={{ fontSize: "0.9rem", color: "#86efac" }}>{w.totalArea > 0 ? "m²" : ""}</span></div>
                </div>
              </div>
